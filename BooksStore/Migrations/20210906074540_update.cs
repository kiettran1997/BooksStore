    ...
    public partial class update : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookInCategorys", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "AuthorId", "CategoryId", "Description", "Image", "Name", "Price", "PublisherId" },
                values: new object[,]
                {
                    { 1, 2, 1, "", "", "Hamlet", 10000m, 1 },
                    { 3, 1, 1, "", "", "Othello", 10000m, 1 },
                    { 2, 1, 2, "", "", "King Lear", 10000m, 2 }
                });

            migrationBuilder.InsertData(
                table: "Oders",
                columns: new[] { "Id", "AddDate", "CustomerId", "Note", "TotalPrice" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, null, 0m },
